                  ...
                  ?>
                    <tr>
                      <th class="pl-0 border-0" scope="row">
                        ...
                        ?>
                        <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.php"><img src="img/<?= $img['name']; ?>" alt="..." width="70" /></a>
                          <div class="media-body ml-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.php"><?= $product['name']; ?></a></strong></div>
                        </div>
                      </th>
                      ...
                      <td class="align-middle border-0">
                        <p class="mb-0 small">$<?= $product['sale']; ?></p>
                      </td>
                      <td class="align-middle border-0"><a class="reset-anchor" href="functions/delete_cart.php?id=<?= $cart['cart_id']; ?>"><i class="fas fa-trash-alt small text-muted"></i></a></td>
                    </tr>
                  <?php endforeach; ?>
                  <?php endforeach; ?>
                </tbody>
